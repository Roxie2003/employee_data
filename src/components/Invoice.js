                        ...
                        <table className='w-full text-left border-b-2 border-black'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>{employeeInfo.bank_details.acc_no + ", " + employeeInfo.bank_details.name + ", " + employeeInfo.bank_details.IFSC_code}</td>
                                </tr>
                            </tbody>
                        </table>
                        <table className='w-[50%] text-left border-2 border-l-0 border-black'>
                            <tbody>
                                <tr className='border-2 border-l-0 border-black'>
                                    <th className='border-2 border-l-0 border-black'>Attendance Details</th>
                                    <th className='border-2 border-black'>Days</th>
                                </tr>
                                <tr className='border-2 border-l-0 border-black'>
                                    <td className='border-2 border-l-0 border-black'>Present Days</td>
                                    <td className='border-2 border-black'>{selectedAttendance.present_days} Days</td>
                                </tr>
                                <tr className='border-2 border-l-0 border-black'>
                                    <td className='border-2 border-l-0 border-black'>Overtime</td>
                                    <td className='border-2 border-black'>{selectedAttendance.overtime_hrs} Hours</td>
                                </tr>
                            </tbody>
                        </table>
                        <table className='w-full text-left border-t-2 border-black'>
                            <tbody>
                                <tr className='border-t-2 border-b-2 border-black'>
                                    <th className='border-2 border-l-0 border-black w-[50%]'>Earning</th>
                                    <th className='border-2 border-black w-[10%]'>Amount</th>
                                    <th className='border-2 border-black w-[30%]'>Deduction</th>
                                    <th className='border-2 border-r-0 border-black w-[10%]'>Amount</th>
                                </tr>
                                <tr className=''>
                                ...
                                <tr className=''>
                                    <th className='border-2 border-l-0 border-black'>Total Earning</th>
                                    <th className='border-2 border-b-0 border-black'>{employeeInfo.base_salary + overtime_cost}</th>
                                ...
                                <tr className=''>
                                    ...
                                    <th className=''>{employeeInfo.base_salary + overtime_cost}</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
